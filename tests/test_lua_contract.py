...
class LuaContractTests(unittest.TestCase):
    ...
    def test_live_discovery_feeds_search_and_minimap_button_toggles_browser(self) -> None:
        ...
        for method in ("PublishItem", "PublishNPC", "PublishQuest", "FlushLive", "GetWorkingRealm"):
        ...
        self.assertIn("LIVE_FLUSH_DELAY", capture)
        self.assertIn("existing._signature == signature", capture)
        self.assertIn('source == "tooltip" and record.itemInfoCaptured', capture)
